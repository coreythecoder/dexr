                ...
                <div class="row grid-space-0">
                    ...
                    <div class="col-sm-3 plan stripped">
                        ...
                        <ul>
                            ...
                            <li><a href="https://app.dexr.io/register" class="btn btn-dark btn-animated">Get Started <i class="fa fa-user"></i></a></li>
                        </ul>
                    </div>
                    <!-- pricing table end -->
                    ...
                    <div class="col-sm-3 plan stripped">
                        ...
                        <ul>
                            ...
                            <li><a href="https://app.dexr.io/register" class="btn btn-default btn-animated">Start 7-Day Trial <i class="fa fa-user"></i></a></li>
                        </ul>
                    </div>
                    <!-- pricing table end -->
                    ...
                    <div class="col-sm-3 plan stripped best-value">
                        ...
                        <ul>
                            ...
                            <li><a href="https://app.dexr.io/register" class="btn btn-default btn-animated">Sign Up <i class="fa fa-user"></i></a></li>
                        </ul>
                    </div>
                    <!-- pricing table end -->
