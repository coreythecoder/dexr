                ...
                <form method="POST" id="opt-out" name="opt_out">
                    ...
                    <div class="row field">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            ...
                            <input type='text' class='form-control' name='first' placeholder='John' required="required" value="<?php if (isset($_POST['first']) && !empty($_POST['first'])) {
                                echo $this->input->post("first");
                            } ?>">
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <label>Your Last Name</label>
                            <input type='text' class='form-control' name='last' placeholder='Doe' required="required" value="<?php if (isset($_POST['last']) && !empty($_POST['last'])) {
                    ...
                    <div class="row field" style="margin-top:25px;">
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            ...
                            <input type='text' class='form-control' name='email' placeholder='you@email.com' required="required" value="<?php if (isset($_POST['email']) && !empty($_POST['email'])) {
                                echo $this->input->post("email");
                            } ?>">
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <label>The Email Address Used To Register The Domain(s)</label>
                            <input type='text' class='form-control' name='reg_email' placeholder='you@email.com' required="required" value="<?php if (isset($_POST['reg_email']) && !empty($_POST['reg_email'])) {
