    ...
    <div class="page-header inner list-sub" style="z-index: 999; background-color:#5BC506;">
        <div class='row'>
            <div class='col-md-3 center-xs'>
                <h1 style='font-size: 20px; color:white; line-height: 1;'><i class='fa fa-list white'></i> Email > Targeting</h1>  
            </div>
            ...
            <div class='col-md-1 col-xs-12 center-xs' style='margin-top:12px; margin-bottom:-8px;'>
                <div class='text-center center-xs'><a href="/email/targeting/create" class="btn btn-default btn-xs" ><i class="fa fa-plus"></i></a>   </div>
            </div>
        </div>
    </div>   
</div>
